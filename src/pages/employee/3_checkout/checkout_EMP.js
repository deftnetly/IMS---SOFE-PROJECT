...
(function () {
  ...
  function wireFilters() {
    ...
    if (catEl) catEl.addEventListener("change", () => renderProductGrid("", catEl.value));
  }
  ...
  window.addToCart = function () {
    ...
    addProductToCart(matched.id, qty);
    renderProductGrid("", document.getElementById("productCategoryFilter")?.value || "all");
    searchInput.value = "";
    qtyInput.value = "1";
    searchInput.focus();
  };
